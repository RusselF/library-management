    ...
    <div className="min-h-screen flex" style={{ background: "#f9f5f2" }}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className = "relative z-10">
          <h2 className="text-white text-3xl font-bold leading-snug mb-3">
            Join our reading<br />community.
          </h2>
          <p className="text-white/70 text-sm">Create an account and start borrowing today.</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-2xl font-bold text-slate-800 mb-1">Create a new account.</h1>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full border rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 transition ${
                  errors.name ? "border-red-300 focus:ring-red-200" : "border-slate-200 focus:ring-amber-100"
                }`}
          ...
          <p className="text-center text-sm text-slate-400 mt-6">
            ...
            <Link to="/login" className="font-semibold hover:underline" style={{ color: "#5c3d2e" }}>
              Sign in
            </Link>
          </p>
        </div>
